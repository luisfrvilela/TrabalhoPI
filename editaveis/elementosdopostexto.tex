...
\section{Balan�o financeiro para a manuten��o}

\subsection{Cercamento}

Primeira op��o: Estoque

O t�cnico em eletr�nica ganha em m�dia 1000 reias

\begin{itemize}
          \item O auxiliar de manuten��o no ramo de cercamento ganha em m�dia entre 724 reais e 1124 reais mensais \cite{catho}
          \item Furadeira - Impacto profissional 3000 rpm - GSB 16 RE- 314 reais � vista
          \item Broca HSS-G 8x75x117mm Bosch- \$ 7,90 \cite{agrotama}
          \item Parafuso Madeira Cabe�a Chata Lat�o Polido Cartela Com 10 Pe�as Vonder 3,2X20 Mm - 11.90 reais \cite{fixpar}
          \item Parafuso madeira fenda philips cabe�a panela chip board tamnho: 4.0x50 Embalagem com 100 UNIDADES - 5.77 reais \cite{fixpar}
          \item Parafuso madeira de fenda simples cabe�a chata tamanho: 6,1X90 Embalagem com 100 unidades - 22.58 reais \cite{fixpar}
\end{itemize}

	Se tratando desta op��o os custos de manuten��o s�o explicitado na tabela acima, sendo o material necess�rio a ser comprado inicialmente. A reposi��o destes materiais s� ocorrer� devido a necessidade de manuten��o ou quando se esgota o prazo de validade de cada elemento.
	
Segunda Op��o: Contrata��o da empresa terceirizada.

	J� em rela��o a segunda op��o para cercamento ficar� sobre o encargo do comprador do projeto para escolher a empresa terceirizada que realizar� essa atividade caso ele escolha essa op��o de manuten��o assim os custos de manuten��o ser�o combinados com o comprador e a empresa no momento da contrata��o. Assim mandamos e-mail para fazer uma simula��o da manuten��o, mas infelizmente n�o houve resposta.
	
\subsection{Ilumina��o}
	
Estoque:

O auxiliar de manuten��o el�trica ganha em m�dia entre 980 reais a 1198 reais mensais \cite{catho} .
	O sistema de manuten��o da ilumina��o ocorrer� apenas com uma vertente que � a do estoque, devido ao segredo industrial dos postes utilizados. Como o fornecimento de energia � publico ent�o essa manuten��o ser� realizada pelo �rg�o p�blico respons�vel.  O estoque ser� realizado com os elementos relatados acima juntamente com o seu respectivo valor. Assim de maneira an�loga ao cercamento esses elementos dever�o ser comprados inicialmente e a reposi��o ocorrer� devido � necessidade de manuten��o e prazo de validade do equipamento.
	
\subsection{Monitoramento}

Primeira op��o: Estoque

O t�cnico em eletr�nica ganha em m�dia 1000 reais mensais

	Os custos desta op��o ser�o de forma an�loga ao cercamento onde inicialmente dever� comprar todos os equipamentos necess�rios descritos acima com o seu respectivo valor, e a reposi��o ocorrer� quando houver a necessidade de manuten��o e o vencimento do prazo de validade do determinado equipamento.
	Em rela��o a motocicleta a manuten��o n�o obedecer� ao estoque pois ficaria invi�vel, ent�o quando houver a necessidade de manuten��o a motocicleta ser� enviada para uma oficina mais pr�xima ou para a autorizada. Vale ressaltar o valor das revis�es, ou seja, as manuten��es preventivas ser�o:
	
Primeira revis�o 1000km ? 58 reias \cite{yamaha} .
Segunda revis�o 5000km ? 25 reais \cite{yamaha} .
Terceira revis�o 10000km ? 216 reais \cite{yamaha} .

	O pre�o da manuten��o tanto na autorizada quanto na oficina depender� da necessidade de manuten��o a ser combinado com a oficina ou com a pr�pria autorizada.
	
Segunda Op��o contrata��o da empresa terceirizada

	J� em rela��o a segunda op��o para monitoramento ficar� sobre o encargo do comprador do projeto para escolher a empresa terceirizada que realizar� essa atividade caso ele escolha essa op��o de manuten��o assim os custos de manuten��o ser�o combinados com o comprador e a empresa no momento da contrata��o. Assim mandamos e-mail para fazer uma simula��o, mas infelizmente n�o houve resposta.
	
\subsection{Custo final Manuten��o}

	Vale ressaltar, que o valor final de manuten��o est� levando em conta um caso extremo, onde na pior das hip�teses supondo que todas as c�meras t�m algum tipo de problema que as tornem inutilizadas, assim a manuten��o seria de modo a rep�r as c�meras, e o valor da manuten��o seria, a soma do valor das c�meras com o valor do outros equipamentos para a manuten��o do cercamento e monitoramento. Sabe-se que a ilumina��o n�o entra nessa conta, pois estamos considerando apenas o estoque. Nessas condi��es o valor final � de R\$ 122.690,47. Agora, se tratando de um caso mais comum onde acontece um problema na c�mera e o problema ser� solucionado trocando apenas algum componente da mesma, esse valor de manuten��o depender� da situa��o e necessidade, resultando em um valor final de manuten��o menor do que o considerado acima.
